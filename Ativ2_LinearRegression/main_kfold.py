...
Usa KFold para montar as rodadas/folds.
UFAL 2024
"""
...
import numpy as np
import pandas as pd
from sklearn.model_selection import KFold                 # Rodadas de validação.
...
# Usa o KFold pra preparar as rodadas.
...
for train_index, test_index in kf.split(X):
    ...
    print(f'Rodada {fold}: MSE = {mse}, R² = {r2}')
    fold += 1
